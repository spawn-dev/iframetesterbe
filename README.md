...
```sh
# 1. Bootstrap GraphQL server in directory `iframetesterbe`, based on `typescript-advanced` boilerplate
graphql create iframetesterbe --boilerplate typescript-advanced
